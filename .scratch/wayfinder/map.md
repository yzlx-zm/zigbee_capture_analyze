...
- [中继状态异常分析](issues/09-中继状态异常分析.md) — 中继素材库 (DA13 系列 + G32 + FEED) 专项;模式 1: DA13 网络中继 0x0B 下行 (入网后 2-5s, 与 838D 同构);模式 2: G32 中继 0xBE5A 0x0C 上行 ×216 + 0x06; **L3-5-R2 素材验证通过** (缺失清单 10 项移除);检测器结论修正 (R2 上行)

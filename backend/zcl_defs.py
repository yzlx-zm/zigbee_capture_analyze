...
# ── 特定 Cluster 的 Command ── (S4 2026-08-27: scripts/zap_xml_extract.py 从
# gecko_sdk ZAP XML 自动生成 — 109 簇/369 命令; 勿手改, 重新生成即可)
CLUSTER_COMMANDS: dict[int, dict[int, str]] = CLUSTER_COMMANDS_STD
...
# ── 标准控制簇命令载荷 schema (S4 2026-08-27: ZAP XML 自动生成;
# 方向键 "C→S"/"S→C" 由 _norm_direction 归一化; 私有簇解析在 PAYLOAD_PARSERS)
CMD_PAYLOAD_SCHEMAS: dict[int, dict[int, dict[str, list[_Field]]]] = CMD_PAYLOAD_SCHEMAS_STD

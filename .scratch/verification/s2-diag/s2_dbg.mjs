...
console.log("mc html len:", await ev(`document.getElementById('mc').innerHTML.length`));
console.log("mc text:", (await ev(`document.getElementById('mc').innerText`)).slice(0,300));
console.log("diag-pan:", await ev(`!!document.getElementById('diag-pan')`));
console.log("exceptions:", exceptions.length);
exceptions.slice(0,5).forEach(e=>console.log(" !", e.slice(0,300)));
console.log("modules:", await ev(`typeof window.__diagRerun`));

...
| 文件 | 大小 | 内容 | 验证状态 |
|------|------|------|----------|
| `中继入网抓包(1).cubx` | 667KB | **入网后立即被踢** (用户观测) | ✅ L1-3 B2-LOOP-ROUTE (838D); ✅ **L3-5-R1 验证通过** (2026-08-04: 39 条 0x0B 全 src=0x1885→838D, 13 轮/34s, 交叉提示); 附加发现: TC 踢 0x8A41/0xF67F (L1-4-R2b) |

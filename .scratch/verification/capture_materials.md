...
| `G32_0626.cubx` | 720KB | G32 网络中继错误 (运营期 36min, 中继 0xBE5A) | ✅ **L3-5-R2 验证通过** (2026-08-05: 0x0C ×216/39轮/29min + 0x06 ×38 间接超时; 缺失清单第 10 项移除); MTORR 频率 7.2s/次 (异常高频, 见 relay-status-analysis 模式 2/4) |

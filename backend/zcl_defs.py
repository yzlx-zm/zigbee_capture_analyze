...
CLUSTER_COMMANDS: dict[int, dict[int, str]] = {
    ...
    # Door Lock (0x0101) — S4 (2026-08-27 用户要求对齐 Ubiqua): 官方完整命令表
    # (Silicon Labs command-id.h / UnifySDK, ZCL spec zcl-6.0-15-02018-001);
    # 此前仅 0x00-0x02, 0x20 事件通知类显示原始 ID (用户示例帧实锤)
    0x0101: {
        0x00: "Lock Door",
        0x01: "Unlock Door",
        0x02: "Toggle",
        ...
        0x0B: "Set Weekday Schedule",
        0x0C: "Get Weekday Schedule",
        0x0D: "Clear Weekday Schedule",
        ...
        0x1B: "Get User",
        0x1D: "Clear User",
        0x20: "Operation Event Notification",
        0x21: "Programming Event Notification",
        0x22: "Set Credential",
        0x23: "Set Credential Response",
        0x24: "Get Credential Status",
        0x25: "Get Credential Status Response",
        0x26: "Clear Credential",
    },
